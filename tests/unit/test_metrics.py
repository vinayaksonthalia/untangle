...
def test_sealed_manifest_verification_binds_to_committed_anchor(tmp_path):
    ...
    from eval.sealed import SealedIntegrityError, _verify_sealed_manifest

    src = "data/sealed"  # generated by `python -m eval.sealed` in the CI setup
    _verify_sealed_manifest(src)  # intact frozen holdout -> no raise
