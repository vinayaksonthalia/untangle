...
<div class="wrap">
  ...
  <div class="proof">
    ...
    <div class="stats">
      ...
      <div class="stat"><div class="v ok">0</div><div class="k">Decoy false-positives, across 181 look-alike non-Razorpay credits</div></div>
      <div class="stat"><div class="v">0.938</div><div class="k">Recall on true Razorpay credits — high coverage without gambling</div></div>
      <div class="stat"><div class="v warn">abstains</div><div class="k">on the rest, into a reasoned review queue — never force-matched</div></div>
    </div>
  ...
  <div class="trap">
    <div>
      ...
      <p>untangle refuses to call it Razorpay on resemblance. It needs a <b>hard tie</b> back to the settlement
      report — an exact UTR, a UTR suffix, or a bounded set-sum of settlement nets. Brand words and coincidental
      amounts alone never win. That one rule is the difference between a clean ledger and a corrupted one.</p>
    </div>
    <div class="decoy">
  ...
  <div class="faq">
    ...
    <details><summary>Do you store my bank statement?</summary>
      <p>No. Files are read into memory, reconciled, and discarded — no database, no disk, no analytics on your
      financials, no signup. It's open source, so you can read the exact code that touches your file, or run it
      on your own machine where nothing leaves it at all.</p></details>
